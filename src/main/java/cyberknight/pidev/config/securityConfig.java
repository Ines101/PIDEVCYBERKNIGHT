...
public class securityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable().authorizeRequests()// hasAuthority("ADMIN")
				...
				.antMatchers("/event/**").permitAll()//hasAuthority("ADMIN")
				.antMatchers("/admin/**").permitAll()//.hasAuthority("ADMIN")
				.antMatchers("/accountVerification/**").permitAll()
				.antMatchers("/ads/**").permitAll()//.authenticated()
				.antMatchers("/category/**").permitAll()//.hasAuthority("ADMIN")
				.antMatchers("/ads/AcceptAds").permitAll()//.hasAuthority("ADMIN")
				.antMatchers("/ads/DeclineAds").permitAll()//.hasAuthority("ADMIN")
				.antMatchers("/product/**").permitAll()//.permitAll()
				.antMatchers("/product/Addproduct").permitAll()//.hasAuthority("ADMIN")
				...
				.antMatchers("/reclamation/**").permitAll()//.hasAuthority("CLIENT")
